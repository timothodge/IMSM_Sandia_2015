...
\begin{itemize}
	...
	\item Can you quantify and incorporate stress relaxation and creep?
	\item Incorporation of uncertainty into design optimization.
...
\begin{columns}[c]
	\column{.6\textwidth}
		\begin{itemize}
			...
			\item If satisfied, the user can stop. 
			
			\item If not satisfied, the user can go back to the definition of the problem, and run again. 
			
			\item The user will have the chance to redefine the problem.
...
\begin{columns}[c]
	\column{.5\textwidth}
		\begin{figure}[h]
		 	...
		 	\caption{Creep interpreted graphically}
		 	\label{fig:Creep}
		\end{figure}	
		\vspace{-.2in}
		\begin{figure}[h]
