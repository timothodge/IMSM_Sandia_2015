...
\column{.5\textwidth}
\begin{itemize}
	\item Design an algorithm to optimize spring design with the robustness to handle type of design specifications
	\item Quantify and incorporate stress relaxation and creep as optional specifications
	\item Account for manufacturing constraints by including uncertainty in design optimization
...
\column{.5\textwidth}
\begin{itemize}
	\item Algorithm needs certain capabilities to be useful
	\item Feasibility Testing, Sensitivity Analysis, Optimization

	
\end{itemize}
\column{.5\textwidth}
\begin{figure}[h]
		 \begin{center}\includegraphics[scale=.30]{IMSM_Workflow.png}\end{center}
...
\end{figure}
	...
	\column{.5\textwidth}
	\begin{figure}[h]
		 \begin{center}\includegraphics[scale=.30]{IMSM_Workflow1.png}\end{center}
...
\begin{columns}[c]
	\column{.5\textwidth}
				\begin{equation*}
 					\begin{gathered}
 						...
 						\mbox{subject to } \mathbf{G}(\mathbf{x}) \le 0
 					\end{gathered}
				\end{equation*}
	...
	\column{.5\textwidth}
	\begin{figure}[h]
		 \begin{center}\includegraphics[scale=.30]{IMSM_Workflow2.png}\end{center}
...
\column{.5\textwidth}
\begin{figure}[h]
		 \begin{center}\includegraphics[scale=.25]{Case_56_38910new.eps}\end{center}
		 \caption{Feasibility Region}
		 \label{fig:Region2}
\end{figure}	
\column{.5\textwidth}
	\begin{figure}[h]
		 \begin{center}\includegraphics[scale=.30]{IMSM_Workflow3.png}\end{center}
...
\begin{columns}[c]
	\column{.6\textwidth}
	\begin{itemize}
		\item Increasing the design space dimension increases computational expense
	...
	\column{.4\textwidth}
		\begin{figure}[h]
			 \begin{center}\includegraphics[scale=.3]{IMSM_Workflow4.png}\end{center}
...
\begin{columns}[c]
	...
	\column{.4\textwidth}
		...
		\begin{figure}[h]
		 \begin{center}\includegraphics[scale=.3]{IMSM_Workflow5.png}\end{center}
...
\begin{columns}[c]
	\column{.6\textwidth}
		\begin{itemize}
			\item Analyze optimization results
			
			\item User determines how to proceed
			
			\item Allows for a variety of outcomes		
	...
	\column{.4\textwidth}
		...
		\begin{figure}[h]
		 \begin{center}\includegraphics[scale=.3]{IMSM_Workflow7.png}\end{center}
...
\frame{
	\begin{itemize}
		\item Summary:
		\begin{itemize}
			\item Designed a flexible algorithm for spring optimization, with a variety of objective 
				functions and constraints. 
			\item Chose models for stress relaxation and creep, and incorporated them into our 						optimization.
			
		\end{itemize}
		\item Future Work
		\begin{itemize}
		 	\item The implementation of design optimization under uncertainty into the current model.
