...
\author[Sandia National Laboratories Group]{A. Bentley, T. Hodges, J. Jiang, J. Krueger, S. Nnannapaneni, T. Qiu}
...
\frametitle{Problem}
\begin{itemize}[<+->]
\item What is an algorithm that optimizes springs with interchangeable constraints and objectives? 
\item Can you quantify and incorporate spring force relaxation?
\end{itemize}
}
