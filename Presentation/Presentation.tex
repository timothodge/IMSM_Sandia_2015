...
\column{.5\textwidth}
\begin{figure}[h]
		 \begin{center}\includegraphics[scale=.25]{IMSM_Workflow.png}\end{center}
...
\end{figure}
	...
	\column{.5\textwidth}
	\begin{figure}[h]
		 \begin{center}\includegraphics[scale=.25]{IMSM_Workflow1.png}\end{center}
		 \caption{User Input}
...
\begin{columns}[c]
	...
	\column{.5\textwidth}
	\begin{figure}[h]
		 \begin{center}\includegraphics[scale=.25]{IMSM_Workflow2.png}\end{center}
...
\column{.5\textwidth}
	\begin{figure}[h]
		 \begin{center}\includegraphics[scale=.25]{IMSM_Workflow3.png}\end{center}
		 \caption{Feasibility}
...
\begin{columns}[c]
	...
	\column{.4\textwidth}
		\begin{figure}[h]
			 \begin{center}\includegraphics[scale=.25]{IMSM_Workflow4.png}\end{center}
			 \caption{Sensitivity}
...
\begin{columns}[c]
	...
	\column{.4\textwidth}
		...
		\begin{figure}[h]
		 \begin{center}\includegraphics[scale=.25]{IMSM_Workflow5.png}\end{center}
...
%  {\includegraphics[width=1.0\textwidth]{Creepvideo.mp4}
%
}
\section{Future Work}
\frame{
