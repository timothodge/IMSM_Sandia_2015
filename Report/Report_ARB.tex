...
The first restriction placed on the user's problem statement was to require that the optimization problem is formulated as a minimization or maximization of a weight sum of predefined objectives.  Second, the list of potential constraints.  


First, we require the user to present the optimization as a weighted combination of objective functions to be minimized.  



In our problem, we studied optimal spring designs.  Our approach included designing software that optimizes a spring design to a set of user specified objectives and constraints, analyzing potential constraints that have not been well specified and extending the optimization problem to account for uncertainty.
