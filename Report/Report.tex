...
\label{sec:Case2}
%Case_56_28910
	\textbf{Objectives:} Spring rate and spring index.\\
	\textbf{Constraints:} Relation on inner, wire, and outer diameter, coil binding gap, buckling slenderness, and maximum shear stress. \\
...
%Case_11_348
	...
	\textbf{Objectives:} Stress Relaxation\\
	...
	\textbf{State Variables:} $d_{i}$, $d_{w}$, and $N_{t}$ \\
		...
		\begin{figure}[h]
		 \begin{center}\includegraphics[scale=.65]{Case_11_348.eps}\end{center}
		 \caption{Example of feasible region.}
		 \label{Feasible Example}
...
\textbf{Analysis of stress relaxation and creep models.}

\textbf{Basics about uni-axial creep and stress relaxation}
