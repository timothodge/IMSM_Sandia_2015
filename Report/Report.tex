...
\[
{P_z(t)\over P_z(0)} = {M(t)\over M(0)} = \frac{4}{ G\theta d_{\text{w}}^{4}}\int_0^{d_{\text{w}}} r^2 \left( (G\theta r)^{-n} + {c\over k} Gnt^k \right)^{-{1\over n}} \,\mathrm{d} r
\]
where
\[
\theta = {2s\over \pi N_{\text{a}} ((d_{\text{i}}+d_{\text{o}})/2)^2}
\]
...
\[
{}_{2}F_1 \left( {4\over n},{1\over n};{4+n\over n};{c\theta^n G^{n+1} n t^k\over k} {d_{\text{w}}^{n}\over 2^n}\right)
\]
...
\[
P_z^0{d_{\text{i}}+\frac{d_{\text{o}}}{ 4}}=M(0)=2\pi\int_{0}^{d_{\text{w}}} r^2 \sigma(r,t)\,\mathrm{d} r
={\pi\over 4}{n+1\over 4+3n}\left( {8d_{\text{w}}^{4+3n}\dot{s} \over t^{k-1} (d_{\text{i}}+d_{\text{o}})^2 \pi N_{\text{a}} c (d_{\text{i}}+d_{\text{o}})^2} \right)^{{1\over n+1}}
\]
It can be deduced that the spring length $s$ follows
\[
s(t) = s(0) + \left( {(d_{\text{i}}+d_{\text{o}})P_z^0\over \pi}{4+3n\over n+1} \right)^{n+1} {\pi (d_{\text{i}}+d_{\text{o}})^2 N_{\text{a}} c\over 8kd_{\text{w}}^{4+3n}} t^k
\]
