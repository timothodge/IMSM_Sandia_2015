...
This list of parameters and attributes is not exhaustive, but it does demonstrate the inherent complexities found in spring design. Requiring spring design that must satisfy both upper and lower bounds on each of the attributes is not uncommon. As a result formulating the exact problem statement as given by the required spring design must be precise and can benefit from a standard convention. This lends itself to a mathematical formulation.
