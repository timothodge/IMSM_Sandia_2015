...
%    \centerline{$9 \leq N_{t} \leq 17$}
%    
% \centerline{${4\over G_{sr}\theta d_{\text{w}}^4}\int_0^{d_{\text{w}}} r^2 \left( (G_{sr}\theta r)^{-n} + {c\over k} G_{sr}nt^k \right)^{-{1\over n}} \,\mathrm{d} r \ge .85$}
%%\begin{center} where $\theta = {2s\over \pi N_a (d_{\text{i}}+d_{\text{w}})^2}$ \end{center}
%\centerline{where $\theta = {2s\over \pi N_a (d_{\text{i}}+d_{\text{w}})^2}$}
