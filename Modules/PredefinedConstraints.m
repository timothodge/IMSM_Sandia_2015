...
outer_diam_greater.name = 'outerDiamGreater';
...
outer_diam_max.name = 'outerDiamMax';
...
buckling_slenderness.name = 'bucklingSlenderness';
...
min_stress_relaxation.dependicies= {'Norton_Bailey_n','Norton_Bailey_c','Norton_Bailey_k','wire_diameter','inner_diameter','deflection','total_number_of_coils','shear_modulus_stress_relaxation'};
...
max_creep.dependicies= {'inner_diameter','wire_diameter','total_number_of_coils','creep_force','Norton_Bailey_n','Norton_Bailey_k','Norton_Bailey_c'};
