...
%Assume time = 3E6 seconds for both stress relaxation and creep tests
...
stress_relaxation.expression = @(Spring) -hypergeom([4/Spring.Norton_Bailey_n 1/Spring.Norton_Bailey_n],...
    ...
    *Spring.shear_modulus^(Spring.Norton_Bailey_n+1)*Spring.Norton_Bailey_n*(3E6)^Spring.Norton_Bailey_k*...
...
creep.expression = @(Spring) ((Spring.inner_diameter+Spring.outer_diameter)*Spring.creep_force...
    ...
    *Spring.Norton_Bailey_c*(3E6)^Spring.Norton_Bailey_k/8/Spring.Norton_Bailey_k...
