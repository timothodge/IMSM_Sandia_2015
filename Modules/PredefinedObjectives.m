...
stress_relaxation.expression = @(Spring) -hypergeom([4/Spring.Norton_Bailey_n 1/Spring.Norton_Bailey_n],...
    ...
    (2*Spring.deflection/pi/(Spring.total_number_of_coils-2)/((Spring.inner_diameter+Spring.outer_diameter)/2)^2)^Spring.Norton_Bailey_n...
    *Spring.shear_modulus_stress_relaxation^(Spring.Norton_Bailey_n+1)*Spring.Norton_Bailey_n*(3E8)^Spring.Norton_Bailey_k*...
    Spring.wire_diameter^Spring.Norton_Bailey_n/2^Spring.Norton_Bailey_n/Spring.Norton_Bailey_k);
stress_relaxation.direction = 1;
stress_relaxation.dependicies= {'Norton_Bailey_n','Norton_Bailey_c','Norton_Bailey_k','wire_diameter','inner_diameter','outer_diameter','deflection','total_number_of_coils','shear_modulus_stress_relaxation'};
...
creep.expression = @(Spring) ((Spring.inner_diameter+Spring.outer_diameter)*Spring.creep_force...
    ...
    *pi*(Spring.inner_diameter+Spring.outer_diameter)^2*(Spring.total_number_of_coils-2)...
...
creep.direction = 1;
creep.dependicies= {'inner_diameter','outer_diameter','wire_diameter','total_number_of_coils','creep_force','Norton_Bailey_n','Norton_Bailey_k','Norton_Bailey_c','time_creep'};
