...
%
    ...
    properties
        ...
        outer_diameter; % d_o in meters
        minimum_outer_diameter; %d_o_min
        ...
        length_at_open_position = 40e-3; %L_open in meters
%         minimum_length_at_open_position = 20e-3;
%         maximum_length_at_open_position = 60e-3
        
        length_at_close_position = 35e-3; %L_close in meters
...
%         maximum_length_at_hard_stop_position = 50e-3;
        ...
        length_at_reset; 
%         minimum_length_at_reset = 20e-3;
%         maximum_length_at_reset = 60e-3;
    ...
    properties(Constant)
     ...
     methods
        ...
        function Spring =  Set_Rest_Of_Properties(obj)
         obj.outer_diameter = obj.inner_diameter + 2*obj.wire_diameter;
         obj.minimum_outer_diameter = obj.minimum_inner_diameter + 2*obj.minimum_wire_diameter;
         obj.maximum_outer_diameter = obj.maximum_inner_diameter + 2*obj.maximum_wire_diameter;   
...
%         obj.maximum_spring_rate = obj.minimum_shear_modulus/8/(obj.minimum_total_number_of_coils-2)*obj.maximum_wire_diameter^4/(obj.minimum_inner_diameter+obj.minimum_wire_diameter)^3;%k_max   
        ...
        obj.coil_binding_gap = (obj.length_at_hard_stop_position - obj.total_number_of_coils*obj.wire_diameter)/(obj.total_number_of_coils-1);
%         obj.minimum_coil_binding_gap = eps;
%         obj.maximum_coil_binding_gap = 5e-4;
        
        obj.pitch = (obj.length_at_no_compression - 2*obj.wire_diameter)/(obj.total_number_of_coils-2);
...
%         obj.maximum_pitch = (obj.maximum_length_at_no_compression - 2*obj.minimum_wire_diameter)/obj.minimum_active_number_of_coils;
        ...
        obj.diametral_expansion = obj.wire_diameter + sqrt((obj.inner_diameter + obj.wire_diameter)^2 + (((obj.length_at_no_compression - 2*obj.wire_diameter)/(obj.total_number_of_coils-2))^2 - obj.wire_diameter^2)/pi^2);% d_expand
