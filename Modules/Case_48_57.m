...
%{
    Objectives: closed_diametral_expansion, coil_binding_gap
    
    Constraints: max_spring_rate, eq_preload_force

    Variables: 'inner_diameter', 'wire_diameter', 'total_number_of_coils'

    Status: Everything works but there is no feasible region.
...
objFcnParts = {closed_diametral_expansion, coil_binding_gap};
...
consPart = {max_spring_rate, eq_preload_force};
